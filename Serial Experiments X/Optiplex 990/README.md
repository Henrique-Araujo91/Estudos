...
Foi simples instalar Windows 7 em um SSD. Porém isso foi feito antes da Baía 5.25 Orico vir, e no momento que ela veio, o simples ato de remover o leitor de CD e mudar a entrada SATA do sistema operacional. Isso imediatamente causou uma tela azul da morte (BSOD), e eu me lembrei (ou aprendi) de algo que era padrão Microsoft até recentemente; basicamente a maneira com que a empresa via computadores naquela época, era de que o usuário não iria modificar o hardware sem a ajuda de especialistas, de maneira que até algo simples como mudar a entrada SATA do disco que possuia o Sistema Operacional iria causar problemas. Lição aprendida e Windows 7 reinstalado.

E então eu notei que a bateria CMOS estava morta. Por sorte, tenho uma balança por perto que doou a bateria à causa (nos dias seguintes eu comprei uma bateria nova para a balança quando fui no mercado).
